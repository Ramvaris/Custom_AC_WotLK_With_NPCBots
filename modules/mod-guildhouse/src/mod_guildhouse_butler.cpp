...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
    {
        ...
        case 9858: // Neutral Auctioneer
            ...
            break;
        case 7: // Spawn Profession Trainers (Dalaran Grand Master NPCs — neutral, all factions)
            ClearGossipMenuFor(player);
            ...
            SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
            break;
        case 8: // Secondary Profession Trainers (Dalaran Grand Master NPCs)
            ClearGossipMenuFor(player);
            ...
            AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "Cooking Trainer", GOSSIP_SENDER_MAIN, 28705, "Spawn Cooking Trainer?", GuildHouseProf, false);
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "Go Back!", GOSSIP_SENDER_MAIN, 9);
            SendGossipMenuFor(player, DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
            break;
        case 9: // Go back!
