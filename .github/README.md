...
- **Server-Side Pet Scaling Disabled** - The server no longer applies level-based shrinking to hunter pets. Note: The 3.3.5a client has its own hardcoded pet scaling for creatures with tameable families (family > 0) - this client-side behavior cannot be fixed server-side (see [TrinityCore #24551](https://github.com/TrinityCore/TrinityCore/issues/24551)).
